...
public class PlayerActivity extends Activity implements SurfaceHolder.Callback,
    ...
    protected void setAdvertiseData() {
        ...
        byte[] uuid = getIdAsByte(UUID.fromString("5A4BCFCE-174E-4BAC-A814-092E77F6B7E5"));
        ...
        mManufacturerData.put(19, (byte)0x7b); // second byte of Major
        mManufacturerData.put(20, (byte)0x00); // first minor
        mManufacturerData.put(21, (byte)0x0f); // second minor
    ...
    private void startBeacon() {
        ...
        setAdvertiseData();
        mBluetoothAdvertiser.startAdvertising(mAdvertiseSettings, mAdvertiseData, mAdvertiseCallback);
    }
